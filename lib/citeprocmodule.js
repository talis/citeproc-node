...
CSL.Util.FlipFlopper = function (state) {
    ...
    this.quotechars = ['"', "'"];
    tagdefs = [
        ["<em>", "</em>", "italics", "@font-style", ["italic", "normal","normal"], true],
        ["<strong>", "</strong>", "bold", "@font-weight", ["bold", "normal","normal"], true],
...
CSL.Output.Formats.prototype.html = {
    ...
    "bibstart": "<blockquote class=\"csl-bib-body\">\n",
    "bibend": "</blockquote>",
    ...
    "@bibliography/entry": function (state, str) {
        ...
        return "  <p class=\"csl-entry\">" + str + "</p>\n" + insert;
    },
